...
//go:generate minimock -i github.com/biryanim/avito-tech-pvz/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, user *model.UserRegistration) (u1 uuid.UUID, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, user *model.UserRegistration)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mUserRepositoryMockCreate

	funcGet          func(ctx context.Context, email string) (up1 *model.User, err error)
	funcGetOrigin    string
	inspectFuncGet   func(ctx context.Context, email string)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, user *model.UserRegistration) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) ExpectUserParam2(user *model.UserRegistration) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, user *model.UserRegistration)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Return(u1 uuid.UUID, err error) *UserRepositoryMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, user *model.UserRegistration) (u1 uuid.UUID, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, user *model.UserRegistration) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (e *UserRepositoryMockCreateExpectation) Then(u1 uuid.UUID, err error) *UserRepositoryMock {
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, user *model.UserRegistration) (u1 uuid.UUID, err error) {
...
func (mmGet *mUserRepositoryMockGet) Expect(ctx context.Context, email string) *mUserRepositoryMockGet {
	...
	mmGet.defaultExpectation.params = &UserRepositoryMockGetParams{ctx, email}
...
// ExpectEmailParam2 sets up expected param email for UserRepository.Get
func (mmGet *mUserRepositoryMockGet) ExpectEmailParam2(email string) *mUserRepositoryMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.paramPtrs.email = &email
	mmGet.defaultExpectation.expectationOrigins.originEmail = minimock.CallerInfo(1)

	return mmGet
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Get
func (mmGet *mUserRepositoryMockGet) Inspect(f func(ctx context.Context, email string)) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, email string) (up1 *model.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserRepositoryMockGet) When(ctx context.Context, email string) *UserRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockGetExpectation{
		mock:               mmGet.mock,
		params:             &UserRepositoryMockGetParams{ctx, email},
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, email string) (up1 *model.User, err error) {
	...
	if mmGet.inspectFuncGet != nil {
		mmGet.inspectFuncGet(ctx, email)
	}

	mm_params := UserRepositoryMockGetParams{ctx, email}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockGetParams{ctx, email}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmGet.t.Errorf("UserRepositoryMock.Get got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGet.GetMock.defaultExpectation.expectationOrigins.originEmail, *mm_want_ptrs.email, mm_got.email, minimock.Diff(*mm_want_ptrs.email, mm_got.email))
			}
	...
	if mmGet.funcGet != nil {
		return mmGet.funcGet(ctx, email)
	}
	mmGet.t.Fatalf("Unexpected call to UserRepositoryMock.Get. %v %v", ctx, email)
	return
}
